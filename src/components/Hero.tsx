        ...
        <div ref={ref} className="reveal grid lg:grid-cols-[1.15fr_0.85fr] gap-12 lg:gap-16 items-center">
          <div>
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <a
                href="#projets"
                className="inline-flex items-center justify-center rounded-full bg-violet px-6 py-3 text-sm font-semibold text-white hover:bg-violet-bright transition-colors shadow-lg shadow-violet/25"
              >
                Voir mes projets
              </a>
              <a
              ...
              <a
                href="#contact"
                className="inline-flex items-center justify-center rounded-full border border-cyan/30 px-6 py-3 text-sm font-semibold text-cyan hover:bg-cyan/10 transition-colors"
              >
                Me contacter
              </a>
            </div>
